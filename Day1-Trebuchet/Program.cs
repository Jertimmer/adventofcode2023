...
// var input = new List<string>(){"99lbqpxzzlbtvkmfrvrnmcxttseven",
// "q7cnfslbtpkvseven",
...
//27+78+58=163
// input = @"[""2eightbzsp2pfg7eightv7"",
// ""seven6pljhqnineightjjsvnqblk2nineight"",
// ""5nurieivbnieurvoneight""]";


//97 + 77 + 64 + 21 + 55 + 87 + 23 + 36 + 43 + 41 + 48 + 47 + 52 +81+59 = 831
...
{
//     // var finder = new DigitFinder(x);
//     // var digits = finder.FindFirstLastDigits();
//     // var number = digits.first.ToString() + digits.last.ToString();
//     // allMatches.Add(x,number);
//     //
     var parsed = x
         .Replace("one", "o1ne")
         .Replace("two", "t2wo")
   ...
   // var matches = regex.Matches(x);
    ...
    {
        matchList.Add(matchList.First());
    }
    
    //var finalMatches = matchList.ToList();
    
    var firstLast = new List<string>(){matchList.First().Value, matchList.Last().Value};
    
    var number = string.Join(string.Empty,firstLast );
    allMatches.Add(x,number);
}
...
//     { "nine", 9 }
// };
// var reverseNumberTable = new Dictionary<string, int>
// {
//     { "eno", 1 },
//     { "owt", 2 },
//     { "eerht", 3 },
...
//     var left = 0;
//     var right = 0;
//     var leftParsed = false;
//     var rightParsed = false;
//
...
//         if (!leftParsed)
//         {
//             leftParsed = int.TryParse(l.ToString(), out left);
//
//             if (!leftParsed)
//             {
//                 var writtenNumber = numberTable.FirstOrDefault(x => line[j..].StartsWith(x.Key));
//
//                 if (writtenNumber.Key != null)
//                 {
//                     left = writtenNumber.Value;
//                     leftParsed = true;
//                 }
//             }
//         }
...
//         if (!rightParsed)
//         {
//             rightParsed = int.TryParse(r.ToString(), out right);
//
//             if (!rightParsed)
//             {
//                 var reverseLine = new string(line.Reverse().ToArray());
//                 var writtenNumber = reverseNumberTable.FirstOrDefault(x => reverseLine[j..].StartsWith(x.Key));
//
//                 if (writtenNumber.Key != null)
//                 {
//                     right = writtenNumber.Value;
//                     rightParsed = true;
//                 }
//             }
//         }
...
//
// Console.WriteLine($"The sum of the numbers is {result.Sum()}");
